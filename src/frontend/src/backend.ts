...
export class Backend implements backendInterface {
    ...
    async addQuestion(arg0: QuestionDTO): Promise<void> {
    ...
    async getExamConfig(): Promise<ExamConfig> {
        if (this.processError) {
            try {
                const result = await this.actor.getExamConfig();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getQuestions(): Promise<Array<QuestionDTO>> {
        if (this.processError) {
            try {
    ...
    async getUserAttempts(arg0: Principal): Promise<Array<Attempt>> {
        if (this.processError) {
            try {
    ...
    async setExamConfig(arg0: ExamConfig): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setExamConfig(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitAttempt(arg0: SubmitAttemptInput): Promise<SubmitAttemptResult> {
        if (this.processError) {
            try {
                const result = await this.actor.submitAttempt(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
